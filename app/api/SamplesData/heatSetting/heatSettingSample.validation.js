// Validation rules for Heat Setting Sample
export const heatSettingSampleValidation = {
  validateCreateSample(data) {
    ...
    const stringFields = [
      "sampleItemCode", "construction", "color", "customerName", 
      "customerRequiredWidth", "customerRequirementLengthPercent", 
      "customerRequirementWidthPercent", "weightBW", "yard", 
      "afterDryerWidthInch", "dryerSkewCM", "afterShrinkageSkewCM", 
      "afterShrinkageWidthInch", "boxPercentRightHand", "boxPercentLeftHand",
      "afterWashWidthPercent", "afterWashLengthPercent", "afterWashWidthInch",
      "sampleProcessingDetails", "afterWashSkewCM", "burnerQ", "machineSpeed",
      "machineWidthSetting", "tempSetting"
    ]
  ...
  validateUpdateSample(data) {
    ...
    const stringFields = [
      ...
      "afterWashSkewCM", "processingType", "burnerQ", "machineSpeed",
      "machineWidthSetting", "tempSetting"
    ]
